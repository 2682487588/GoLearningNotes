...
~~~go
http://localhost:8080/5lmh?age=11&name=%E6%9E%AF%E8%97%A4&birthday=2006-01-02
~~~

![image-20220122163125784](C:%5CUsers%5C%E4%B8%BF%E5%89%91%E6%9D%A5%C2%B7%5CAppData%5CRoaming%5CTypora%5Ctypora-user-images%5Cimage-20220122163125784.png)
...
func main() {
	...
	/*
	   curl -X GET "http://127.0.0.1:8080/51mh?name=&age=12&address=beijing"
	   curl -X GET "http://127.0.0.1:8080/51mh?name=lmh&age=12&address=beijing"
	   curl -X GET "http://127.0.0.1:8080/51mh?name=adz&age=12&address=beijing"
	*/
	r.GET("/5lmh", func(c *gin.Context) {
		var person Person
...
当业务系统对验证信息有特殊需求时，例如：**返回信息需要自定义**，**手机端**返回的信息需要是**中文**而**pc端**发挥返回的信息需要时**英文**，如何做到请求一个接口满足上述三种情况。
...
func startPage(c *gin.Context) {
   ...
   //正确的链接：
   //http://localhost:8080/5lmh?user_name=枯藤&tag_line=9&tag_line2=33&locale=zh
   //http://localhost:8080/5lmh?user_name=枯藤&tag_line=9&tag_line2=3&locale=en 返回英文的验证信息
   //http://localhost:8080/5lmh?user_name=枯藤&tag_line=9&tag_line2=3&locale=zh 返回中文的验证信息
}
```